...
public class Fractal extends JPanel implements Runnable {
	...
	private static final Rectangle2D UNIT_RECTANGLE =
	        new Rectangle2D.Double(0.0, 0.0, UNIT, UNIT);
	...
	public void paintComponent(Graphics g) {
		...
		drawFractal(SIERPINSKI_TRANSFORMS, g2, 10);
	}

	private void drawFractal(
	        AffineTransform[] transforms, Graphics2D g2, int level) {
		if (level == 0) {
			g2.draw(UNIT_RECTANGLE);
		} else {
